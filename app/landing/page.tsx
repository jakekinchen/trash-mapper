...
export default function LandingPage() {
  return (
    <main className="min-h-[calc(100vh-6.125rem)] flex flex-col items-center justify-center relative overflow-hidden" style={{ backgroundColor: '#f1ffe9' }}>
      ...
      <section className="z-10 flex flex-col items-center justify-center px-6 py-16">
        <h1 className="text-5xl sm:text-7xl font-extrabold text-[#057c3d] text-center drop-shadow-lg mb-4 tracking-tight leading-[4rem]">
        ...
        <div className="mt-10 flex gap-4">
          <Link href="/" className="inline-block rounded-full bg-[#057c3d] px-8 py-4 text-lg font-bold text-white text-center content-center shadow-lg hover:bg-[#045d2a] transition">
            Explore the Map
          </Link>
          <Link href="/events" className="inline-block rounded-full bg-[#5ac8fa] px-8 py-4 text-lg font-bold text-white text-center content-center shadow-lg hover:bg-[#3bb2e0] transition">
